...
[](https://medium.freecodecamp.org/bet-you-cant-solve-this-google-interview-question-4a6e5a4dc8ee) [## 打赌你解决不了这个谷歌面试问题。

### 把棘手的问题分成小块。

medium.freecodecamp.org](https://medium.freecodecamp.org/bet-you-cant-solve-this-google-interview-question-4a6e5a4dc8ee) 
...
[](https://hackernoon.com/20-string-coding-interview-questions-for-programmers-6b6735b6d31c) [## 程序员的 20+字符串编码面试问题

### 除了数组、二叉树和链表数据结构，字符串是编程工作中的另一个热门话题…

hackernoon.com](https://hackernoon.com/20-string-coding-interview-questions-for-programmers-6b6735b6d31c) 
...
[](https://medium.freecodecamp.org/an-intro-to-algorithms-dynamic-programming-dd00873362bb) [## 算法导论:动态编程

### 简而言之，我们可以说动态规划技术主要用于优化问题

medium.freecodecamp.org](https://medium.freecodecamp.org/an-intro-to-algorithms-dynamic-programming-dd00873362bb) 
...
[](https://click.linksynergy.com/deeplink?id=JVFxdTr9V80&mid=39197&murl=https%3A%2F%2Fwww.udemy.com%2Fdynamic-programming-i%2F) [## 动态编程-我的世界

### 理解动态编程的最好方法是什么？我应该直接跳到问题上还是花大量的时间在…

click.linksynergy.com](https://click.linksynergy.com/deeplink?id=JVFxdTr9V80&mid=39197&murl=https%3A%2F%2Fwww.udemy.com%2Fdynamic-programming-i%2F) 

# 算法本身会有偏差吗？莫明·马利克

其中一篇文章，你真的很想读，它有点太专业了，所以你们中的一些人可能不喜欢，但对于那些喜欢深潜的人来说，这是值得一读的。检查数据对算法性能的影响，以及它如何使你的算法有偏差。

[](/berkman-klein-center/can-algorithms-themselves-be-biased-cffecbf2302c) [## 算法本身会有偏差吗？

### 是的，但是首先决定使用机器学习要重要得多。
...
[](/@codingfreak/binary-tree-interview-questions-and-practice-problems-439df7e5ea1f) [## 二叉树面试问题和练习题

### 二叉树是一种树数据结构，其中每个节点最多有两个子节点，称为左…

medium.com](/@codingfreak/binary-tree-interview-questions-and-practice-problems-439df7e5ea1f) 
...
### 对于大多数新人来说，机器学习算法可能看起来太枯燥和复杂，难以掌握…

towardsdatascience.com](https://towardsdatascience.com/top-10-machine-learning-algorithms-for-data-science-cdb0400a25f9) 
...
[](https://medium.freecodecamp.org/how-to-remove-falsy-values-from-an-array-in-javascript-e623dbbd0ef2) [## 如何在 JavaScript 中从数组中移除 falsy 值

### 在 JavaScript 中有很多方法可以从数组中移除元素，但是最简单的方法是什么呢

medium.freecodecamp.org](https://medium.freecodecamp.org/how-to-remove-falsy-values-from-an-array-in-javascript-e623dbbd0ef2) 
...
[](/afteracademy/why-do-students-fail-in-algorithms-and-data-structure-interviews-for-top-companies-4fcca7ce7580) [## 为什么学生在顶尖公司的算法和数据结构面试中会失败？

### 计算机科学是一个充满梦想机会的领域。全世界数以百万计的学生都期待着…

medium.com](/afteracademy/why-do-students-fail-in-algorithms-and-data-structure-interviews-for-top-companies-4fcca7ce7580) 
